    ...
    <section class="m-body-area">
      ...
      <div class="section">
        <div class="container-xl">
          <p class="h1">마감임박 <i class="bi bi-fire"></i></p>
              ...
              <ul class="swiper-wrapper card-list">
                <li class="swiper-slide">
                  <div class="card p-4 d-flex flex-column">
                    ...
                    <!-- 데드라인/ 시작예정일 - 예상기간 -->
                    <div class="mb-1 text-body-secondary"><span class="deadline" style="color: red;">(D-3)</span>2.4 - 3.19</div>
                    <!-- 직무 -->
                ...
                <li class="swiper-slide">
                  <div class="card p-4 d-flex flex-column">
                    ...
                    <!-- 데드라인/ 시작예정일 - 예상기간 -->
                    <div class="mb-1 text-body-secondary"><span class="deadline"style="color: red;">(D-4)</span>2.4 - 3.19</div>
                    <!-- 직무 -->
                    <div class="d-flex job-box mb-3">
                      <span class="badge rounded-pill bg-primary">프론트</span>
                      <span class="badge rounded-pill bg-secondary">백</span>
                ...
                <li class="swiper-slide">
                  <div class="card p-4 d-flex flex-column">
                    ...
                    <!-- 데드라인/ 시작예정일 - 예상기간 -->
                    <div class="mb-1 text-body-secondary"><span class="deadline"style="color: red;">(D-6)</span>2.4 - 3.19</div>
                    <!-- 직무 -->
                    <div class="d-flex job-box mb-3">
                      <span class="badge rounded-pill bg-primary">프론트</span>
                      <span class="badge rounded-pill bg-secondary">백</span>
                ...
                <li class="swiper-slide">
                  <div class="card p-4 d-flex flex-column">
                    ...
                    <!-- 데드라인/ 시작예정일 - 예상기간 -->
                    <div class="mb-1 text-body-secondary"><span class="deadline" style="color: red;">(D-7)</span>2.4 - 3.19</div>
                    <!-- 직무 -->
                    <div class="d-flex job-box mb-3">
                      <span class="badge rounded-pill bg-primary">프론트</span>
                      <span class="badge rounded-pill bg-secondary">백</span>
                ...
                <li class="swiper-slide">
                  <div class="card p-4 d-flex flex-column">
                    ...
                    <!-- 데드라인/ 시작예정일 - 예상기간 -->
                    <div class="mb-1 text-body-secondary"><span class="deadline" style="color: red;">(D-1)</span>2.4 - 3.19</div>
                    <!-- 직무 -->
                    <div class="d-flex job-box mb-3">
                      <span class="badge rounded-pill bg-primary">프론트</span>
                      <span class="badge rounded-pill bg-secondary">백</span>
                ...
                <li class="swiper-slide">
                  <div class="card p-4 d-flex flex-column">
                    ...
                    <!-- 데드라인/ 시작예정일 - 예상기간 -->
                    <div class="mb-1 text-body-secondary"><span class="deadline" style="color: red;">(D-2)</span>2.4 - 3.19</div>
                    <!-- 직무 -->
                    <div class="d-flex job-box mb-3">
                      <span class="badge rounded-pill bg-primary">프론트</span>
                      <span class="badge rounded-pill bg-secondary">백</span>
          ...
          <div class="filter-box mb-5">
            <ul class="d-flex">
                          ...
                          <li>
                            <div class="form-check skill-item">
                              <label class="form-check-label">
                                ...
                                HTML5
                                <!-- <img alt="hmmaa" src="images/ico_html5.png"> -->
                              </label>
                            </div>
                          </li>
                          <li>
              ...
              <li>
                <div class="d-flex">
                  <div class="m-select">
                    <select class="form-select" aria-label="선호지역 1단계(시)" title="선호지역 1단계(시)" id="si" onchange="selectSi()">
                  ...
                  <div class="m-select">
                    <select class="form-select" aria-label="선호지역 1단계(도)" title="선호지역 1단계(도)" id="do" disabled="disabled">
