								...
								<form class="row g-3 needs-validation" novalidate>
									...
									<div class="col-12">
										<div class="m-input-box">
											<label for="loginId01" class="form-label">아이디</label> <input type="text" class="form-control" id="loginId01" required="">
									...
									<div class="col-12">
										<div class="m-input-box">
											<label for="loginPassword01" class="form-label">비밀번호</label> <input type="text" class="form-control" id="loginPassword01" required="">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form class="row g-3 needs-validation" novalidate>
						...
						<div class="col-12">
							<div class="m-input-box">
								<label for="loginId02" class="form-label">아이디</label> <input type="text" class="form-control" id="loginId02" required="">
								<div class="invalid-feedback">아이디를 입력해주세요.</div>
							</div>
						</div>
