      ...
      <div class="container-xl">
        ...
        <div class="con_wrap py-5">
          ...
          <div class="comp_box">
            ...
            ㄴ<a href="http://localhost:3306/IT_MeetUp/Content/MyPage/S_ApplyManagement.jsp"
              target="_blank">http://localhost:3306/IT_MeetUp/Content/MyPage/S_ApplyManagement.jsp</a>

            <h2 class="comp_tit02">목록3(그룹리스트형)</h2>
            ㄴ<a href="http://localhost:3306/IT_MeetUp/Content/MeetGroup/S_GroupSetup.jsp"
            ...
            ㄴ<a href="http://localhost:3306/IT_MeetUp/Content/ProjectLounge/S_PostList.jsp"
              target="_blank">http://localhost:3306/IT_MeetUp/Content/ProjectLounge/S_PostList.jsp</a>

            <div class="comp_tit02">등록1(작성형)</div>
            ㄴ<a href="http://localhost:3306/IT_MeetUp/Content/WritePost/S_WritePost.jsp"
            ...
            ㄴ<a href="http://localhost:3306/IT_MeetUp/Content/MeetGroup/S_WorkManage.jsp"
            ...
            ㄴ<a href="http://localhost:3306/IT_MeetUp/Content/Site/S_Login.jsp"
          ...
          <div class="comp_box">
            ...
            <p class="comp_txt"><strong>* 체크박스</strong></p>
            ...
            <p class="comp_txt"><strong>* 라디오 버튼</strong></p>
            <div class="comp_flexbox">

              <!-- 기본 -->
              <div class="form-check">
                <label class="form-check-label">
                  <input class="form-check-input" type="radio" name="radio01" id="">
                  Default radio
                </label>
              </div>
              ...
              <div class="form-check">
                <label class="form-check-label">
                  <input class="form-check-input" type="radio" name="radio01" id="" checked>
              ...
              <div class="form-check">
                <label class="form-check-label">
                  <input class="form-check-input" type="radio" name="radio01" id="" disabled>
                  Disabled radio
                </label>
              </div>
            ...
            <p class="comp_txt"><strong>* 셀렉트</strong></p>
            <ul class="row">
              <li class="col-3">
                <!-- 기본 -->
                <div class="m-select">
            ...
            <p class="comp_txt"><strong>* 인풋</strong></p>
            <!-- valid / invalid -->
            <form class="row needs-validation" novalidate>
              <!-- 기본 -->
              <div class="col-3 m-input-box">
                <label for="validationCustom01" class="form-label">기본</label>
              ...
              <div class="col-3 m-input-box">
                ...
                <input type="text" class="form-control" id="validationCustom02" required disabled>
                <div class="invalid-feedback">
                  제목2을 입력해주세요.
                </div>
              </div>
              ...
              <div class="col-3 m-input-box">
                ...
                <input type="text" class="form-control form-control-plaintext" id="validationCustom04"
            ...
            <p class="comp_txt"><strong>* textarea, file, color picker</strong></p>
            <div class="row">
              <div class="col-4">
            ...
            <p class="comp_txt"><strong>* 달력</strong></p>
            <div class="row">
              <div class="col-4">
          ...
          <div class="comp_box">
            ...
            <ul>
              ...
              <li>
                ...
                <div class="comp_tit02">a, buttton, input 의 버튼</div>
              ...
              <li>
                ...
                <div class="comp_tit02">'disabled'이 적용된 a, buttton, input 의 버튼</div>
                ...
                <input class="btn btn-primary" disabled type="reset" value="Reset">
              </li>
            </ul>
          </div>
          <!-- //버튼 -->
          ...
          <div class="comp_box">
            ...
            <div class="modal fade" id="exampleModal01" tabindex="-1" aria-labelledby="exampleModal01Label"
              aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModal01Label">팝업01 제목</h1>
            ...
            <div class="modal fade" id="exampleModal02" tabindex="-1" aria-labelledby="exampleModal02Label"
              aria-hidden="true">
              <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                  <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModal02Label">팝업02 제목</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
          ...
          <div class="comp_box">
            ...
            <div>
              <p class="comp_txt"><strong>* <a href="https://icons.getbootstrap.kr/#%EC%82%AC%EC%9A%A9%EB%B2%95"
                    style="color: blue; text-decoration: underline;">부트스트랩 아이콘</a></strong></p>
          ...
          <div class="comp_box">
            ...
            <ul>
              ...
              <li>
                <div class="comp_tit02">여러개의 프로그래스바 노출</div>

                <!-- progress-bar-animated: 움직이는 바 형태 -->
