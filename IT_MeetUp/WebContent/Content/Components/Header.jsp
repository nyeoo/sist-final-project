											...
											<div class="tab-pane fade show active" id="pick-alert"
												...
												<div class="tab-pane fade show active" id="pick-alert"
													...
													<div class="alert" role="alert">
														...
														<hr class="my-2">
														<p>
															<strong>흑곰불꽃발바닥님이 신청하신 팀 개설 요청에 픽!되었습니다.</strong> (픽된 멤버로
											...
											<div class="tab-pane fade" id="dday-alert" role="tabpanel"
												...
												<div class="alert" role="alert">
													<strong><span class="badge text-bg-success">디데이
															알림</span></strong> <span class="text-muted float-end small"> 2024년
										...
										<ul class="nav nav-tabs" role="tablist">
											...
											<li class="nav-item" role="presentation">
												<button class="nav-link"
													id="weekly-report-missing-alert-tab" data-bs-toggle="tab"
