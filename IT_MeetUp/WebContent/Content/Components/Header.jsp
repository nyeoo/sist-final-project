		...
		<div class="offcanvas offcanvas-end text-bg-dark m-right-nav" id="navbarsExample05">
			...
			<div class="offcanvas-body">
				...
				<ul class="navbar-nav me-2 mb-lg-0">
					<li class="nav-item dropdown list-group"><a class="nav-link nav-icon m-ball" href="#" data-bs-toggle="dropdown" aria-expanded="false">
							<i class="bi bi-bell-fill"></i><span class="blind">알림</span> <span class="badge bg-primary badge-number">4</span>
					</a> <!-- 팝업으로 표시되는 알림 내용 -->
						<div class="dropdown-menu dropdown-menu-end notifications" id="notificationPopup" style="width: 600px;">
							...
							<div class="tab-content">
								<div class="tab-pane fade show active" id="pick-alert" role="tabpanel" aria-labelledby="pick-alert-tab">
									<!-- 픽알림 내용 -->
									<p>※흑곰불꽃발바닥님이 신청하신 팀 개설 요청에 픽!되었습니다. (픽된 멤버로 프로젝트가 만들어집니다. 신청을 취소하실 경우 신고처리가 부여됩니다.)</p>
									<p>
										<a href="#">링크</a>
									</p>
									<p>※꽃미남주형이님이 신청하신 팀 개설 요청에 픽!되었습니다. (픽된 멤버로 프로젝트가 만들어집니다. 신청을 취소하실 경우 신고처리가 부여됩니다.)</p>
									<p>
										<a href="#">링크</a>
									</p>
									<p>※아라라라랄님이 신청하신 팀 개설 요청에 픽!되었습니다. (픽된 멤버로 프로젝트가 만들어집니다. 신청을 취소하실 경우 신고처리가 부여됩니다.)</p>
									<p>
										<a href="#">링크</a>
									</p>
								</div>
