	...
	public String pageIndexList(int currentPage, int totalPage, String listUrl)
	{
		...
		*/
		...
		if( (totalPage>numPerBlock) && (currentPageSetup>0) )
		{
			...
			strList.append("<li class=\"page-item\">" + 
					"<a class=\"page-link\" href='" + listUrl + "pageNum=" + n + "' aria-label=\"Previous\">"
		...
		while( (page<=totalPage) && (page<=currentPageSetup+numPerBlock) )
		{
			if(page==currentPage)	// 현재 페이지
			{
				...
				strList.append("<li class=\"page-item active\" aria-current=\"page\"><a class=\"page-link\" href='" + listUrl + "pageNum=" + page + "'>" + page + "</a></li>");
				
			}else
			{
				//strList.append("<a href='"+ listUrl +"pageNum="+ page +"'>"+ page +"</a>");
				strList.append("<li class=\"page-item\"><a class=\"page-link\" href='" + listUrl + "pageNum=" + page + "'>" + page + "</a></li>");
			}
			page++;
		}
		...
		if( (totalPage-currentPageSetup) > numPerBlock )
		{
			...
			strList.append("<li class=\"page-item\">" + 
					"<a class=\"page-link\" href='" + listUrl + "pageNum=" + n + "' aria-label=\"Next\">"
					+ "<span aria-hidden=\"true\">&gt;</span>"
					+ "</a></li>");
		}
		...
		if( (totalPage>numPerBlock) && (currentPageSetup+numPerBlock<totalPage) )
		{
			...
			strList.append("<li class=\"page-item\">"
					+ "<a class=\"page-link\" href='" + listUrl + "pageNum=" + totalPage + "' aria-label=\"Previous\">"
